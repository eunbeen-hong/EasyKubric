...
def render(scene, renderer, collisions, FLAGS, rng, output_dir, blur=False):
    if blur:
        ...
        output_dir = output_dir.with_name(output_dir.name + "_blur")
    else:
        renderer.set_motion_blur(0.0)
    ...
    # Save to image files
    logging.info("Saving the results to '%s' ...", output_dir)
