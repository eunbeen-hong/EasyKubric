...
max_num_dynamic_objects=10

camera="linear_movement_linear_lookat"  # choose from fixed_random, linear_movement, linear_movement_linear_lookat
...
for i in $(seq 0 $((iter-1))); do
    output_dir=/datasets/kubric/examples/dynamic_low_steprate/${i}
